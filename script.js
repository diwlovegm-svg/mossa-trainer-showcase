...
const trainers = [
  {
    ...
    certificates: "Personal Trainer Certification (PESA) • Functional Fusion Training • Weight Loss Specialist • Training Clients with Lower Back Pain • Youth Exercise Essentials • Life Saving and Water Rescue / Lifeguard Training",
  ...
  },
  {
    ...
    specialties: ["Strength", "Fat Loss", "Body Shape", "Lower Back Care", "Beginner"],
  ...
  },
  {
    ...
    education: "วิทยาศาสตรบัณฑิต สาขาวิทยาศาสตร์การกีฬา มหาวิทยาลัยบูรพา",
  ...
  },
  {
    ...
    classes: ["Urbanize", "Body Jam Les Mills", "Pound Pro", "Step Aerobic", "K-Pop Fitness", "Body Combat Les Mills", "Aerobic Dance", "Zumba Basic Step 1"],
  ...
  },
  {
    ...
    shortDescription: "Circuit, Boxing, HIIT, Core และฟื้นฟูกล้ามเนื้อด้วยศาสตร์การนวด",
    education: "วิทยาศาสตรบัณฑิต สาขาวิทยาศาสตร์การกีฬาและการออกกำลังกาย สถาบันการพลศึกษา วิทยาเขตชลบุรี",
    specialties: ["Circuit", "Boxing", "HIIT", "Core", "Strength", "Sports Massage", "Therapeutic Massage"],
    ...
    suitableFor: "ลูกค้าที่ต้องการฝึก Circuit, Boxing, HIIT, Core เพิ่มความแข็งแรง ฟื้นฟูกล้ามเนื้อ หรือนวดเพื่อคลายตึง",
    filterCategories: ["strength", "class", "fatloss"],
  },
  {
    name: "T.AI",
